...
O motor do Phyll está para abrir em [agentphyll.com](https://agentphyll.com). Os comandos abaixo funcionam quando o pacote `phyll` estiver no npm; até lá, o scanner roda a partir deste repositório com `node skills/phyll/scripts/scan.mjs <pasta>`.
...
Cada um deles é um dos 53 sinais do catálogo do Phyll. O catálogo em forma de dados, com os detectores que acham sinais no código, está em [skills/phyll/data/tells.json](skills/phyll/data/tells.json), e os testes conferem cada detector contra código de verdade e contra os quatro apps de exemplo.
